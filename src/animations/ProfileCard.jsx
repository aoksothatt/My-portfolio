...
import mysecimg from "../assets/photo_2026-01-03_09-41-35.jpg";

const DEFAULT_INNER_GRADIENT =
  "linear-gradient(145deg, rgba(6, 78, 59, 0.9) 0%, rgba(16, 185, 129, 0.6) 100%)";
...
const ProfileCardComponent = ({
  ...
  const handleContactClick = useCallback(() => {
    window.open("https://web.facebook.com/thattCo2/", "_blank");
    onContactClick?.();
  }, [onContactClick]);
